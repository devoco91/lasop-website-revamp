        ...
        <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-center flex-grow-1 pe-3">
                ...
                <DropdownToggle className='fw-bold normal' caret >Courses</DropdownToggle >
              ...
              <li className="nav-item norm">
                <Link className="nav-link norm" to="/about">About</Link>
              </li>
              <li className="nav-item norm">
                <Link className="nav-link norm" to="/faq">FAQs</Link>
              </li>
              <li className="nav-item norm">
                <Link className="nav-link norm" to="/blog">Blog</Link>
              </li>
              {
                login ?
                  <Dropdown isOpen={dropdownOpen2} toggle={toggle2} >
                    <DropdownToggle className='fw-bold norm' caret>
