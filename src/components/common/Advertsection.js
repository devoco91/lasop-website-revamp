    ...
    <div className="advert">
          <div className="container">
            <div className="row justify-content-between align-items-center">
              <div className="col-md-5 position-relative  mx-md-0">

                <img src={user3} alt="" className='img-fluid img-thumbnail d-block' />
                <img src={user4} alt="" className='img-fluid img-thumbnail d-block' />
                <img src={user2} alt="" className='img-fluid img-thumbnail d-block temi' />

              </div>
              <div className="col-md-2">
                <img className='d-block m-auto learnt' src={doubleline} alt="" />
              </div>
