...
function CallToAction() {
  ...
  const nameChange = e => setNames(e.target.value);
  ...
  return (
    ...
    <button type="button" class="btn btn-lg d-block" data-bs-toggle="modal" data-bs-target="#modalId">
       <img style={{width: "2rem"}} src="./../../../images/Prospectus.png" alt="" />
     </button>
            ...
            <div class="modal-body">
              ...
              <form >
                ...
                <div className="d-flex my-4 gap-2 align-items-center">
                  <input  id='ads' type="checkbox" className='h-100 p-2 ' value={name} onChange={nameChange} />
                  <label htmlFor='ads' className='fw-bold'>I agree to receive promotional email</label>
                </div>

                
                  <button disabled={!names} className="btn btn-md btn-success w-100">
